package notjorgecompany.BuenosAires.webpay;
...
import notjorgecompany.BuenosAires.BaseController;
...
//    @RequestMapping(value = "/webpaycontroller", method = RequestMethod.GET)
...
//    }
    ...
    public ModelAndView webpayplus( HttpServletRequest request) {
        ...
        return new ModelAndView("shopping-cart", "details", details);
    }
